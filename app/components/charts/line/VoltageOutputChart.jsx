...
const fetcher = async (
  ...
  if (result.message === "Success") {
    ...
    if (process.env.NODE_ENV === "development") {
      console.log("Error in fetch Voltage Output Linear chart");
    }
  }
};

const RealTimeVoltageOutputSplineChart = ({
  tenant,
  locationid,
  online,
  unstableConnection,
...
export default RealTimeVoltageOutputSplineChart;
