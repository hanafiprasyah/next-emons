...
export default function Voltage() {
    ...
    try {
      ...
      if (data.message === "Success") {
        ...
        if (selectedDevice.code && selectedDevice.name) {
          ...
          if (
            data.monitoring["data"]["datavoltages"] === undefined ||
      ...
      setResponseTime(null);
      if (process.env.NODE_ENV === "development") {
        console.log("Error in fetchVoltageRealtime: ", err);
      }
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === "development") {
      console.log("Effect triggered with data:", voltageData);
    }
    ...
    if (voltageData?.length > 0) {
      setLastDataVoltage((prev) => {
        const newData = {
          v_rs_input:
            voltageData[0].v_rs_input != null
              ? voltageData[0].v_rs_input
              : prev.v_rs_input,
          v_st_input:
            voltageData[0].v_st_input != null
              ? voltageData[0].v_st_input
              : prev.v_st_input,
          v_rt_input:
            voltageData[0].v_rt_input != null
              ? voltageData[0].v_rt_input
              : prev.v_rt_input,
          v_rn_input:
            voltageData[0].v_rn_input != null
              ? voltageData[0].v_rn_input
              : prev.v_rn_input,
          v_sn_input:
            voltageData[0].v_sn_input != null
              ? voltageData[0].v_sn_input
              : prev.v_sn_input,
          v_tn_input:
            voltageData[0].v_tn_input != null
              ? voltageData[0].v_tn_input
              : prev.v_tn_input,
          v_rs_output:
            voltageData[0].v_rs_output != null
              ? voltageData[0].v_rs_output
              : prev.v_rs_output,
          v_st_output:
            voltageData[0].v_st_output != null
              ? voltageData[0].v_st_output
              : prev.v_st_output,
          v_rt_output:
            voltageData[0].v_rt_output != null
              ? voltageData[0].v_rt_output
              : prev.v_rt_output,
          v_rn_output:
            voltageData[0].v_rn_output != null
              ? voltageData[0].v_rn_output
              : prev.v_rn_output,
          v_sn_output:
            voltageData[0].v_sn_output != null
              ? voltageData[0].v_sn_output
              : prev.v_sn_output,
          v_tn_output:
            voltageData[0].v_tn_output != null
              ? voltageData[0].v_tn_output
              : prev.v_tn_output,
        };
  ...
  const voltageValues = {
    v_rs_input:
      voltageData && voltageData[0]?.v_rs_input != null
        ? voltageData[0].v_rs_input
        : lastDataVoltage.v_rs_input,
    v_st_input:
      voltageData && voltageData[0]?.v_st_input != null
        ? voltageData[0].v_st_input
        : lastDataVoltage.v_st_input,
    v_rt_input:
      voltageData && voltageData[0]?.v_rt_input != null
        ? voltageData[0].v_rt_input
        : lastDataVoltage.v_rt_input,
    v_rn_input:
      voltageData && voltageData[0]?.v_rn_input != null
        ? voltageData[0].v_rn_input
        : lastDataVoltage.v_rn_input,
    v_sn_input:
      voltageData && voltageData[0]?.v_sn_input != null
        ? voltageData[0].v_sn_input
        : lastDataVoltage.v_sn_input,
    v_tn_input:
      voltageData && voltageData[0]?.v_tn_input != null
        ? voltageData[0].v_tn_input
        : lastDataVoltage.v_tn_input,
    v_rs_output:
      voltageData && voltageData[0]?.v_rs_output != null
        ? voltageData[0].v_rs_output
        : lastDataVoltage.v_rs_output,
    v_st_output:
      voltageData && voltageData[0]?.v_st_output != null
        ? voltageData[0].v_st_output
        : lastDataVoltage.v_st_output,
    v_rt_output:
      voltageData && voltageData[0]?.v_rt_output != null
        ? voltageData[0].v_rt_output
        : lastDataVoltage.v_rt_output,
    v_rn_output:
      voltageData && voltageData[0]?.v_rn_output != null
        ? voltageData[0].v_rn_output
        : lastDataVoltage.v_rn_output,
    v_sn_output:
      voltageData && voltageData[0]?.v_sn_output != null
        ? voltageData[0].v_sn_output
        : lastDataVoltage.v_sn_output,
    v_tn_output:
      voltageData && voltageData[0]?.v_tn_output != null
        ? voltageData[0].v_tn_output
  ...
  return (
    <div id="voltage-template" className="grid grid-cols-1 gap-0 mt-2">
      {/* Alert */}
      ...
      {param1.length !== 0 || param2.length !== 0 ? (
        <>
          <button
            ...
            } fixed top-3.5 right-32 md:top-24 md:right-8 z-50 py-[7px] duration-200 ease-in-out transition px-2 inline-flex items-center gap-x-1 text-xs font-medium rounded-lg border border-transparent bg-rose-600 dark:bg-rose-700 text-white hover:bg-rose-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-none`}
      ...
      <>
        ...
        <div
          className={`${
            param1.length === 0 || param2.length === 0
              ? "flex flex-col mb-2 bg-white border border-gray-200 mt-0 rounded-xl dark:bg-neutral-800 dark:border-neutral-700"
              : "flex flex-col mb-2 bg-white border border-gray-300 mt-0 rounded-xl dark:bg-neutral-900 dark:border-neutral-800"
          }`}
        >
          {/* Header */}
        ...
        <div
          className={`${
            param1.length === 0 || param2.length === 0
              ? "flex flex-col mt-0 mb-2 bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700"
              : "flex flex-col mt-0 mb-2 bg-white border border-gray-300 rounded-xl dark:bg-neutral-900 dark:border-neutral-800"
          }`}
        >
          {/* Header */}
          <div className="grid grid-cols-3 p-3 md:pt-5 md:px-5 gap-x-2">
        ...
        <div
          className={`${
            param1.length === 0 || param2.length === 0
              ? "flex flex-col mb-2 bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700"
              : "flex flex-col mb-2 bg-white border border-gray-300 rounded-xl dark:bg-neutral-900 dark:border-neutral-800"
          }`}
        >
          {/* Header */}
          <div className="grid grid-cols-3 p-3 md:pt-5 md:px-5 gap-x-2">
