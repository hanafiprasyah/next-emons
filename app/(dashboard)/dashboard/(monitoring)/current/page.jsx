...
export default function Current() {
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === "development") {
      console.log("Effect triggered with data:", currentData);
    }
    ...
    if (currentData) {
      setLastDataCurrent((prev) => {
        const newData = {
          i_r_Input:
            currentData[0].i_r_Input != null
              ? currentData[0].i_r_Input
              : prev.i_r_Input,
          i_r_Output:
            currentData[0].i_r_Output != null
              ? currentData[0].i_r_Output
              : prev.i_r_Output,
          i_s_Input:
            currentData[0].i_s_Input != null
              ? currentData[0].i_s_Input
              : prev.i_s_Input,
          i_s_Output:
            currentData[0].i_s_Output != null
              ? currentData[0].i_s_Output
              : prev.i_s_Output,
          i_t_Input:
            currentData[0].i_t_Input != null
              ? currentData[0].i_t_Input
              : prev.i_t_Input,
          i_t_Output:
            currentData[0].i_t_Output != null
  ...
  const currentValues = {
    i_r_Input:
      currentData && currentData[0]?.i_r_Input != null
        ? currentData[0].i_r_Input
        : lastDataCurrent.i_r_Input,
    i_r_Output:
      currentData && currentData[0]?.i_r_Output != null
        ? currentData[0].i_r_Output
        : lastDataCurrent.i_r_Output,
    i_s_Input:
      currentData && currentData[0]?.i_s_Input != null
        ? currentData[0].i_s_Input
        : lastDataCurrent.i_s_Input,
    i_s_Output:
      currentData && currentData[0]?.i_s_Output != null
        ? currentData[0].i_s_Output
        : lastDataCurrent.i_s_Output,
    i_t_Input:
      currentData && currentData[0]?.i_t_Input != null
        ? currentData[0].i_t_Input
        : lastDataCurrent.i_t_Input,
    i_t_Output:
      currentData && currentData[0]?.i_t_Output != null
        ? currentData[0].i_t_Output
