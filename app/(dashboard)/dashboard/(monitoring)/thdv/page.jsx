...
export default function Thdv() {
  ...
  const [lastDataThdv, setLastDataThdv] = useState(defaultThdvValues); // default to 220 if data is null/undefined
      ...
      if (data.message === "OK") {
        ...
        if (selectDev.length !== 0) {
          ...
          if (
            ...
            data.monitoring["data"]["dataThdvs"][0] === null
          ) {
  ...
  // TODO: Update each thdv in lastDataThdv if data is valid
  useEffect(() => {
    if (process.env.NODE_ENV === "development") {
    ...
    if (data) {
      setLastDataThdv((prev) => {
        const newData = {
          thdv_rs_Input:
            data[0].thdv_rs_Input != null
              ? data[0].thdv_rs_Input
              : prev.thdv_rs_Input,
          thdv_st_Input:
            data[0].thdv_st_Input != null
              ? data[0].thdv_st_Input
              : prev.thdv_st_Input,
          thdv_rt_Input:
            data[0].thdv_rt_Input != null
              ? data[0].thdv_rt_Input
              : prev.thdv_rt_Input,
          thdv_rn_Input:
            data[0].thdv_rn_Input != null
              ? data[0].thdv_rn_Input
              : prev.thdv_rn_Input,
          thdv_sn_Input:
            data[0].thdv_sn_Input != null
              ? data[0].thdv_sn_Input
              : prev.thdv_sn_Input,
          thdv_tn_Input:
            data[0].thdv_tn_Input != null
              ? data[0].thdv_tn_Input
              : prev.thdv_tn_Input,
          thdv_rs_output:
            data[0].thdv_rs_output != null
              ? data[0].thdv_rs_output
              : prev.thdv_rs_output,
          thdv_st_output:
            data[0].thdv_st_output != null
              ? data[0].thdv_st_output
              : prev.thdv_st_output,
          thdv_rt_output:
            data[0].thdv_rt_output != null
              ? data[0].thdv_rt_output
              : prev.thdv_rt_output,
          thdv_rn_output:
            data[0].thdv_rn_output != null
              ? data[0].thdv_rn_output
              : prev.thdv_rn_output,
          thdv_sn_output:
            data[0].thdv_sn_output != null
              ? data[0].thdv_sn_output
              : prev.thdv_sn_output,
          thdv_tn_output:
            data[0].thdv_tn_output != null
              ? data[0].thdv_tn_output
              : prev.thdv_tn_output,
        };
  ...
  // TODO: Set thdv values based on valid data or fallback to last known values
  const thdvValues = {
    thdv_rs_Input:
      data && data[0]?.thdv_rs_Input != null
        ? data[0].thdv_rs_Input
        : lastDataThdv.thdv_rs_Input,
    thdv_st_Input:
      data && data[0]?.thdv_st_Input != null
        ? data[0].thdv_st_Input
        : lastDataThdv.thdv_st_Input,
    thdv_rt_Input:
      data && data[0]?.thdv_rt_Input != null
        ? data[0].thdv_rt_Input
        : lastDataThdv.thdv_rt_Input,
    thdv_rn_Input:
      data && data[0]?.thdv_rn_Input != null
        ? data[0].thdv_rn_Input
        : lastDataThdv.thdv_rn_Input,
    thdv_sn_Input:
      data && data[0]?.thdv_sn_Input != null
        ? data[0].thdv_sn_Input
        : lastDataThdv.thdv_sn_Input,
    thdv_tn_Input:
      data && data[0]?.thdv_tn_Input != null
        ? data[0].thdv_tn_Input
        : lastDataThdv.thdv_tn_Input,
    thdv_rs_output:
      data && data[0]?.thdv_rs_output != null
        ? data[0].thdv_rs_output
        : lastDataThdv.thdv_rs_output,
    thdv_st_output:
      data && data[0]?.thdv_st_output != null
        ? data[0].thdv_st_output
        : lastDataThdv.thdv_st_output,
    thdv_rt_output:
      data && data[0]?.thdv_rt_output != null
        ? data[0].thdv_rt_output
        : lastDataThdv.thdv_rt_output,
    thdv_rn_output:
      data && data[0]?.thdv_rn_output != null
        ? data[0].thdv_rn_output
        : lastDataThdv.thdv_rn_output,
    thdv_sn_output:
      data && data[0]?.thdv_sn_output != null
        ? data[0].thdv_sn_output
        : lastDataThdv.thdv_sn_output,
    thdv_tn_output:
      data && data[0]?.thdv_tn_output != null
        ? data[0].thdv_tn_output
      ...
      <>
        ...
        <div className="flex flex-col mt-2 mb-4 bg-white border border-gray-200 md:mt-0 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <div className="grid grid-cols-3 p-3 md:pt-5 md:px-5 gap-x-2">
            ...
            <div className="shrink-0 relative text-center size-11 w-full md:w-[220px] md:h-[50px] mx-auto">
              <h2 className="text-lg font-semibold lg:text-xl">THDv R-N</h2>
            </div>
          </div>
        ...
        <div className="flex flex-col mb-4 bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <div className="grid grid-cols-3 p-3 md:pt-5 md:px-5 gap-x-2">
            ...
            <div className="shrink-0 relative text-center size-11 w-full md:w-[220px] md:h-[50px] mx-auto">
              <h2 className="text-lg font-semibold lg:text-xl">THDv S-N</h2>
            </div>
          </div>
        ...
        <div className="flex flex-col mb-4 bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <div className="grid grid-cols-3 p-3 md:pt-5 md:px-5 gap-x-2">
            ...
            <div className="shrink-0 relative text-center size-11 w-full md:w-[220px] md:h-[50px] mx-auto">
              <h2 className="text-lg font-semibold lg:text-xl">THDv T-N</h2>
            </div>
          </div>
        ...
        <div className="flex flex-col mb-4 bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <div className="grid grid-cols-3 p-3 md:pt-5 md:px-5 gap-x-2">
            ...
            <div className="shrink-0 relative text-center size-11 w-full md:w-[220px] md:h-[50px] mx-auto">
              <h2 className="text-lg font-semibold lg:text-xl">THDv R-S</h2>
            </div>
          </div>
        ...
        <div className="flex flex-col mb-4 bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <div className="grid grid-cols-3 p-3 md:pt-5 md:px-5 gap-x-2">
            ...
            <div className="shrink-0 relative text-center size-11 w-full md:w-[220px] md:h-[50px] mx-auto">
              <h2 className="text-lg font-semibold lg:text-xl">THDv S-T</h2>
            </div>
          </div>
        ...
        <div className="flex flex-col mb-2 bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <div className="grid grid-cols-3 p-3 md:pt-5 md:px-5 gap-x-2">
            ...
            <div className="shrink-0 relative text-center size-11 w-full md:w-[220px] md:h-[50px] mx-auto">
              <h2 className="text-lg font-semibold lg:text-xl">THDv R-T</h2>
            </div>
          </div>
